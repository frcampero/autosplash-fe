...
const OrderSummaryCards = ({ totalOrders, todayOrders, totalRevenue }: Props) => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
      <div className="bg-card border border-border rounded-md shadow-sm p-4 flex items-center gap-4">
        <CalendarDays className="text-primary" />
        <div>
          <div className="text-xl font-semibold">{todayOrders}</div>
          <div className="text-muted-foreground text-sm">Tickets hoy</div>
        </div>
      </div>
      ...
      <div className="bg-card border border-border rounded-md shadow-sm p-4 flex items-center gap-4">
        ...
        <div>
          ...
          <div className="text-muted-foreground text-sm">Ingresos totales</div>
        </div>
      </div>
      ...
      <div className="bg-card border border-border rounded-md shadow-sm p-4 flex items-center gap-4">
        ...
        <div>
          ...
          <div className="text-muted-foreground text-sm">Tickets totales</div>
        </div>
      </div>
    </div>
  );
